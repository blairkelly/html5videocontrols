...
var vidcontrols = function (target, options) {
	...
	var oncanplay = function () {
		console.log("function: oncanplay");
	    ...
	    //LISTENERS
		var addmorelisteners = function () {
			//this function is called when we're ready to add listeners to the video and its cradle
